...
function App() {
  ...
  const downloadSingleInvoice = (txn) => {
    try {
      ...
      doc.setFont('helvetica', 'normal');
      doc.text(`Generated automatically by FinSense Financial Operating System on ${new Date().toLocaleDateString()}`, 105, 276, { align: 'center' });
      doc.text('This authentic digital PDF document serves as an offline verifiable financial record.', 105, 281, { align: 'center' });

      // 7. Save and Download true .pdf file
      ...
      const downloadUrl = URL.createObjectURL(blobWithMime);
